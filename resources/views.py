...
def home(request):
    ...
    return render(request, 'index.html', {'filter':filter_instance, 'subjects':subjects, 'standard':standard, 'youtube':filter_instance.qs, 'selected_subjects': selected_subjects, 'selected_standard': selected_standard})
...
def qpaper(request):
    ...
    if filter_instance.form.is_valid():
        ...
        selected_subjects = None
        selected_standard = None
    return render(request, 'qpaper.html', {'filter':filter_instance, 'subjects':subjects, 'standard':standard, 'qpapers':filter_instance.qs, 'selected_subjects': selected_subjects, 'selected_standard': selected_standard})
...
def notes(request):
    ...
    if filter_instance.form.is_valid():
        ...
        selected_subjects = None
        selected_standard = None
    return render(request, 'notes.html', {'filter':filter_instance, 'subjects':subjects, 'standard':standard, 'notes':filter_instance.qs, 'selected_subjects': selected_subjects, 'selected_standard': selected_standard})
...
def books(request):
    ...
    if filter_instance.form.is_valid():
        ...
        selected_subjects = None
        selected_standard = None
    return render(request, 'books.html', {'filter':filter_instance, 'subjects':subjects, 'standard':standard, 'books':filter_instance.qs, 'selected_subjects': selected_subjects, 'selected_standard': selected_standard})
